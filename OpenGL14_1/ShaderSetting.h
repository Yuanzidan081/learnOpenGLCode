...
// multi-light shader
void setMultiLightShader(Shader& shader)
{
    shader.useShader();
    ...
    // spotLight
    shader.setVec3("spotLight.position", camera.m_Pos);
    shader.setVec3("spotLight.direction", camera.m_Front);
...
void setModelShader_texture(Shader& shader)
{
    shader.useShader();
